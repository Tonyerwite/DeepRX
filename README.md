...
The current suite contains 29 tests. A complete Fig. 6(a) result must contain exactly eight finite values in every curve, <code>samples_per_point=500</code>, <code>n_frames=1</code>, a valid JSON file, and a readable PNG.
